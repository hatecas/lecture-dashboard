...
== ★ 분량 절대 준수 (최우선 제약) ★ ==
- 본문은 **약 15문장 분량, 공백 포함 500~650자 사이**. (너무 짧으면 정보 부족, 너무 길면 안 읽힘)
- 너무 길면 압축, 너무 짧으면 혜택/근거를 한 줄씩 더해 보강.
- 1~2줄 후크 → 강사 소개·핵심 가치 2~3줄 → 혜택 불릿 3~5개 → 수강생 성과 1~2줄 → 마감/CTA 1~2줄.
- 강사 서사·수강생 케이스는 짧게 인용(1줄씩). 길게 풀지 말 것.
- 작성 후 스스로 글자 수 점검. 500자 미만이면 보강, 650자 초과면 축소.
