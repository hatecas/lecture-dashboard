...
- ★ 본문 구성: 4섹션. **호기심·궁금증을 자극하는 티저(teaser)** 형태로 작성.
  ...
  · 각 섹션 200~400자
- ★ CTA: 오직 "전자책 받으러 가기" 안내만. **무료 라이브 강의 / 무료 강의 / 무료 특강 /
  추가 강의 안내는 절대 포함하지 말 것.** 강의 일정·날짜·시간 자리표시도 X.
- 길이: 전체 800~1500자`
...
반드시 아래 JSON 구조 하나만 출력. 추가 설명 텍스트 절대 금지. 마크다운 코드블록 X.
{
  ...
  "cta": "전자책 받으러 가기 안내만. 무료 라이브 강의·무료 특강·추가 강의 안내 절대 포함 X. 일정/날짜 자리표시도 X."
}

== 톤·문체 강조 ==
- 다나까체("~합니다")와 해요체("~해요", "~거든요")를 자연스럽게 섞어주세요.
- 본문 4섹션은 인사이트의 정답·메커니즘·방법을 풀어쓰지 말고, 호기심을 자극하는 티저로.
- CTA에 무료 강의 안내 넣지 마세요. 전자책 받기만.`
}
